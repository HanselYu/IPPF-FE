...
def Peptide_hemo(features_crafted, features_normalize):
    ...
    with open('Peptide_hemo.pkl', 'wb') as f:
        pickle.dump(model, f)
...
if __name__ == '__main__':
    ...
    if Tag == 'Train':
        ...
        Peptide_hemo(features_crafted, features_normalize)
    elif Tag == 'Predict':
        Sequence = []
        ...
        features_crafted, features_normalize = ALL_features(Sequence, Mysequence)
        features_ensemble = np.concatenate((features_normalize, features_crafted), axis=1)
        with open('Peptide_hemo.pkl', 'rb') as myfile:
