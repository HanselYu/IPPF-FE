...
def Write_features(features_crafted, features_normalize, min_length):
    ...
    res.to_excel('Features_csq.xlsx')
...
if __name__ == '__main__':
    ...
    # Peptide_predict(features_crafted, features_normalize, Label_Resolution)
    ###### Test
    ...
    Peptide_independent(features_crafted, features_normalize, Label_Resolution)
