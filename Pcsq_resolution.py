...
def Protein_csq_resolution(features_crafted, features_normalize, Label_Resolution):
    ...
    with open('Protein_csq_resolution.pkl', 'wb') as f:
        pickle.dump(model, f)
...
if __name__ == '__main__':
    ...
    Dir = sys.argv[2]
    if Tag == 'Train':
        Sequence, Mysequence, Label_Resolution, _ = Load_data()
        features_crafted, features_normalize = ALL_features(Sequence, Mysequence)
        Protein_csq_resolution(features_crafted, features_normalize, Label_Resolution)
    elif Tag == 'Predict':
        Sequence = []
        ...
        features_crafted, features_normalize = ALL_features(Sequence, Mysequence)
        features_ensemble = np.concatenate((features_normalize, features_crafted), axis=1)
        with open('Protein_csq_resolution.pkl', 'rb') as myfile:
