...
def ALL_features(Sequence, sequences_Example):
    # Crafted features
    features_crafted = Get_features(Sequence, 98)
...
def Protein_gpl(features_crafted, features_normalize):
    ...
    with open('Protein_gpl.pkl', 'wb') as f:
        pickle.dump(model, f)
...
if __name__ == '__main__':
    ...
    if Tag == 'Train':
        ...
        Protein_gpl(features_crafted, features_normalize)
    elif Tag == 'Predict':
        Sequence = []
        ...
        features_crafted, features_normalize = ALL_features(Sequence, Mysequence)
        features_ensemble = np.concatenate((features_normalize, features_crafted), axis=1)
        with open('Protein_gpl.pkl', 'rb') as myfile:
